...
public class Entrada {
    ...
    public static int menu() {
        int opcio;
        do {
            System.out.println("\nBIENVENIDA A LA GESTION DE LA BIBLIOTECA");
            System.out.println("1. Crear una nueva colección.");
            System.out.println("2. Añadir libros a una colección específica.");
            System.out.println("3. Introducir recursos digitales para complementar las colecciones.");
