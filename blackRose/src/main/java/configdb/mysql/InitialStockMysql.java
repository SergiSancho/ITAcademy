...
public class InitialStockMysql {
    ...
    private static final String INSERT_INITIAL_STOCK = """
            ...
            INSERT INTO product (name, stock, price, type) VALUES ('Pino de Navidad Grande', 50, 19.99, 'TREE');
            ...
            INSERT INTO product (name, stock, price, type) VALUES ('Cesta de madera', 20, 14.99, 'DECORATION');
            SET @product_id_decoration1 = LAST_INSERT_ID();
                        
            INSERT INTO decoration (id_product, material) VALUES (@product_id_decoration1, 'WOOD');
                        
            INSERT INTO product (name, stock, price, type) VALUES ('Cesta de plástico', 15, 7.99, 'DECORATION');
